import type { Header, httpOptions, HttpServiceRes, IHttpService, Param } from "./IHttpService";

export class HttpService implements IHttpService {

    public async Request(url: string, options: httpOptions): Promise<HttpServiceRes> {
        ...
        const errorMessage = res.ok ? undefined : res.statusText; 
